...
class AnalyticsReport
{
    ...
    private function applyDateFilters($sql, $params, $dateColumn = 'created_at')
    {
    ...
    public function getDriverConversion($filters = [])
    {
        ...
        $dateFiltered = $this->applyDateFilters($sql, [], $filters, 'created_at');
    ...
    public function getCallCenterStats($filters = [])
    {
        ...
        $dateFilteredOutcomes = $this->applyDateFilters($sql_outcomes, [], $filters, 'created_at');
