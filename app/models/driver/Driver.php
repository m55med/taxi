...

{
...

    {
        ...
        try {
            ...
            $sql = "UPDATE drivers SET $setClause, updated_at = UTC_TIMESTAMP() WHERE id = :id";
...

    {
        ...
        try {
            ...
            $insertStmt = $this->db->prepare("
                ...
                VALUES (:driver_id, :doc_id, 'submitted', :note, :user_id, UTC_TIMESTAMP())
...

    {
        ...
        try {
            ...
            return convert_dates_for_display($drivers, ['created_at', 'updated_at']);
...

    {
        ...
        try {
            ...
            // تحويل التواريخ للعرض بالتوقيت المحلي
            if ($driver) {
                return convert_dates_for_display($driver, ['created_at', 'updated_at']);
            }
...

    {
        ...
        try {
            ...
            // تحويل التواريخ للعرض بالتوقيت المحلي
            return convert_dates_for_display($calls, ['created_at', 'updated_at']);
...

{
    ...
    public function updateCoreInfo($driverId, $data) {
        ...
        $sql = 'UPDATE drivers SET name = :name, email = :email, gender = :gender, country_id = :country_id, app_status = :app_status, car_type_id = :car_type_id, notes = :notes, updated_at = UTC_TIMESTAMP() WHERE id = :id';
...

    {
        ...
        $sql = "UPDATE drivers SET `{$field}` = ?, updated_at = UTC_TIMESTAMP() WHERE id IN ({$placeholders})";
