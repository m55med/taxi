...

{
...

    {
        ...
        $sql = "INSERT INTO drivers (name, phone, country_id, car_type_id, data_source, added_by, registered_at)
                ...
                VALUES (:name, :phone, :country_id, :car_type_id, :data_source, :added_by, UTC_TIMESTAMP())";
        ...
        try {
            ...
            $sql = "INSERT INTO referral_visits 
                    ...
                    ON DUPLICATE KEY UPDATE 
                        ...
                        visit_recorded_at = UTC_TIMESTAMP(), 
...

    {
        ...
        $sql = "UPDATE referral_visits 
                ...
                SET registration_status = :status, registration_attempted_at = IF(:status = 'attempted', UTC_TIMESTAMP(), registration_attempted_at)
