...

{
...

    {
        ...
        $sql = "
            ...
            AND (held_by IS NULL OR held_by = ? OR held_at < UTC_TIMESTAMP() - INTERVAL " . self::HOLD_DURATION_MINUTES . " MINUTE)
...

    {
        ...
        try {
            ...
            $updateStmt = $this->db->prepare("UPDATE coupons SET held_by = :userId, held_at = UTC_TIMESTAMP() WHERE id = :couponId");
