                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm font-semibold text-gray-900">
                                                ...
                                                <a href="/listings/tickets?created_by=<?= $user['id'] ?>&start_date=<?= htmlspecialchars($filters['date_from'] ?? '') ?>&end_date=<?= htmlspecialchars($filters['date_to'] ?? '') ?>" class="hover:underline text-indigo-600 transition-colors">
                                ...
                                <td data-label="Team" class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                    ...
                                    <?php if (!empty($user['team_id']) && !empty($user['team_name'])): ?>
                                        ...
                                        <a href="/listings/tickets?team_id=<?= $user['team_id'] ?>&start_date=<?= htmlspecialchars($filters['date_from'] ?? '') ?>&end_date=<?= htmlspecialchars($filters['date_to'] ?? '') ?>" class="hover:underline text-indigo-600">
