                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td data-label="Points" class="px-6 py-4 whitespace-nowrap text-center">
                                    ...
                                    <div x-data="{ tooltip: false }" class="relative">
                                        ...
                                        <div @mouseenter="tooltip = true" @mouseleave="tooltip = false" 
                                             ...
                                             class="inline-flex items-center px-3 py-2 rounded-lg <?= ($user['delegation_applied']) ? 'bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200' : 'bg-gray-50' ?> transition-colors">
                                            ...
                                            <?php if ($user['delegation_applied']): ?>
                                                ...
                                                <i class="fas fa-award text-yellow-500 ml-2 text-sm animate-pulse"></i>
                                        ...
                                        <?php if ($user['delegation_applied']): ?>
                                            ...
                                            <div x-show="tooltip" 
                                                 ...
                                                 class="absolute z-10 w-72 p-4 -mt-32 text-sm leading-tight text-white transform -translate-x-1/2 bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl shadow-2xl border border-gray-700"
                                                ...
                                                <div class="flex items-center mb-2">
                                                    ...
                                                    <p class="font-bold text-yellow-400">Delegation Bonus Applied</p>

                                                </div>

                                                <div class="space-y-1 text-xs">

                                                    <p><strong class="text-gray-300">Base Points:</strong> <span class="text-white"><?= number_format($user['delegation_details']['original_points'], 2) ?></span></p>

                                                    <p><strong class="text-gray-300">Bonus:</strong> <span class="text-green-400">+<?= number_format($user['delegation_details']['percentage'], 2) ?>%</span> <span class="text-gray-400">(+<?= number_format($user['delegation_details']['bonus_amount'], 2) ?> pts)</span></p>

                                                    <p><strong class="text-gray-300">Reason:</strong> <span class="text-white"><?= htmlspecialchars($user['delegation_details']['reason']) ?></span></p>
                                ...
                                <td data-label="Quality" class="px-6 py-4 whitespace-nowrap text-center">
                                    ...
                                    <?php
                                        ...
                                        $quality_text = 'text-gray-600';

                                        if ($quality >= 90) {

                                            $quality_bg = 'bg-green-500';

                                            $quality_text = 'text-green-700';

                                        } elseif ($quality >= 75) {

                                            $quality_bg = 'bg-yellow-500';

                                            $quality_text = 'text-yellow-700';

                                        } elseif ($quality > 0) {

                                            $quality_bg = 'bg-red-500';

                                            $quality_text = 'text-red-700';
                                    ...
                                    <?php if ($reviews_count > 0): ?>
                                        ...
                                        <a href="<?= URLROOT ?>/quality/reviews?agent_id=<?= $user['id'] ?>" 
                                           ...
                                           class="inline-block p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                                            ...
                                            <div class="flex flex-col items-center space-y-2">
                                                ...
                                                <div class="relative w-12 h-12">
                                                    ...
                                                    <svg class="w-12 h-12 transform -rotate-90" viewBox="0 0 36 36">
                                                        ...
                                                        <path class="<?= $quality_text ?>" stroke="currentColor" stroke-width="3" fill="none" 

                                                              stroke-dasharray="<?= $quality ?>, 100" 
                                                    ...
                                                    <div class="absolute inset-0 flex items-center justify-center">
                                                        ...
                                                        <span class="text-xs font-bold <?= $quality_text ?>"><?= round($quality) ?>%</span>
                                                ...
                                                <div class="text-xs text-gray-500 group-hover:text-indigo-600 transition-colors">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="flex flex-col items-center">
                                            ...
                                            <span class="text-xs text-gray-400 mt-1">No reviews</span>
