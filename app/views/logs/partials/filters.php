    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mt-4">
        ...
        <div class="flex items-end space-x-2">
            ...
            <button type="button" id="month-btn"
                class="px-3 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">This Month</button>
            <?php
            ...
            <a href="<?= URLROOT ?>/logs?<?= $all_time_query ?>"
                class="px-3 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">All Time</a>
        </div>
    </div>
