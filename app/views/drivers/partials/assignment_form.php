...
<div class="mt-6 bg-white p-6 rounded-lg shadow-md h-fit">
    ...
    <form action="<?= BASE_PATH ?>/drivers/assign" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea id="note" name="note" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Enter reason for assignment or any other notes..."></textarea>
        </div>
