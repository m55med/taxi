...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">إدارة المنصات</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="md:col-span-1">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h2 class="text-xl font-semibold text-gray-800 mb-4">إضافة منصة جديدة</h2>
                    <form action="<?= BASE_PATH ?>/admin/platforms/store" method="POST">
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700">اسم المنصة</label>
            ...
            <div class="md:col-span-2">
                <div class="bg-white rounded-lg shadow-sm">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h2 class="text-xl font-semibold text-gray-800">المنصات الحالية</h2>
                    </div>
                    <div class="p-0">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">اسم المنصة</th>
                                        ...
                                        <?php foreach ($data['platforms'] as $index => $platform): ?>
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium">
                                                    <form action="<?= BASE_PATH ?>/admin/platforms/delete/<?= $platform['id'] ?>" method="POST" onsubmit="return confirm('هل أنت متأكد من رغبتك في حذف هذه المنصة؟');">
