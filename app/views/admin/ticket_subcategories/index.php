...
if (isset($_SESSION['ticket_subcategory_message'])) {
    ...
    $message = [
        ...
        'text' => $_SESSION['ticket_subcategory_message'],
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <form action="<?= BASE_URL ?>/admin/ticket_subcategories/store" method="POST">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <?php else: ?>
                                ...
                                $categories_map = array_column($data['ticket_categories'], 'name', 'id');
...
<div id="confirmation-modal" class="modal-overlay">
    ...
    <div class="modal-content">
        ...
        <p class="text-gray-600 mb-6">Deleting this subcategory may affect related ticket codes. This action cannot be undone.</p>
