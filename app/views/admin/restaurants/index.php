    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <?php foreach ($restaurants as $restaurant) : ?>
                            ...
                            <tr class="border-b hover:bg-gray-100">
                                ...
                                <td class="py-3 px-4 text-center">
                                    ...
                                    <!-- زر الحذف - يستخدم حل احتياطي موثوق في حالة فشل Alpine.js -->
                                    <button @click="confirmDelete(<?= $restaurant['id'] ?>, '<?= htmlspecialchars($restaurant['name_en'], ENT_QUOTES) ?>')" class="text-gray-500 hover:text-gray-700 mx-1"><i class="fas fa-trash-alt"></i></button>
        ...
        <div x-show="deleteModalOpen" x-cloak
            ...
            <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 transform transition-all duration-300"
                 ...
                 x-transition:leave="scale-105 opacity-100"
            ...
            <div class="p-6">
                <div class="text-center">
                    <div class="mb-4">
                        ...
                        <h4 class="text-xl font-semibold text-gray-900 mb-2">حذف المطعم</h4>
                        <p class="text-gray-600 mb-4">
                            هل أنت متأكد من رغبتك في حذف المطعم:
                        </p>
                        <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            <p class="font-semibold text-gray-900 text-lg" x-text="restaurantToDeleteName"></p>
                            <p class="text-sm text-gray-500 mt-1">ID: <span x-text="restaurantToDelete"></span></p>
                        </div>
                    </div>
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div class="text-right">
                                <p class="text-sm font-medium text-yellow-800">تحذير هام</p>
                                <p class="text-sm text-yellow-700">سيتم حذف جميع البيانات المتعلقة بهذا المطعم نهائياً</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-end space-x-3 p-6 border-t border-gray-200 bg-gray-50 rounded-b-2xl">
                <button @click="closeDeleteModal()"
                        class="px-6 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200">
                    <i class="fas fa-times mr-2"></i>إلغاء
                </button>

                <button @click="deleteRestaurant()"
                        class="px-6 py-2.5 text-sm font-medium text-white bg-red-600 border border-transparent rounded-lg hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-all duration-200">
                    <i class="fas fa-trash-alt mr-2"></i>حذف المطعم
                </button>
            </div>
        </div>
    </div>
...
<script>
    ...
    function restaurantsPage() {
        ...
        return {
            ...
            restaurantToDeleteName: '',

            confirmDelete(id, name) {

                this.restaurantToDelete = id;

                this.restaurantToDeleteName = name;
