...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <form action="<?= BASE_PATH ?>/delegation-types/create" method="POST">
                        ...
                        <?php foreach ($delegationTypes as $type): ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    <form action="<?= BASE_PATH ?>/delegation-types/delete" method="POST" class="inline ml-4" onsubmit="return confirm('Are you sure you want to delete this type?');">
...
<div id="editModal" class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <form id="editForm" action="<?= BASE_PATH ?>/delegation-types/update" method="POST">
