        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="md:col-span-1">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h2 class="text-xl font-semibold text-gray-800 mb-4">إضافة دور جديد</h2>
                    <form action="<?= BASE_PATH ?>/admin/roles/store" method="POST">
                        <div>
            ...
            <div class="md:col-span-2">
                <div class="bg-white rounded-lg shadow-sm">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h2 class="text-xl font-semibold text-gray-800">الأدوار الحالية</h2>
                    </div>
                    <div class="p-0">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">اسم الدور</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($data['roles'] as $role): ?>
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?= htmlspecialchars($role['id']) ?></td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?= htmlspecialchars($role['name']) ?></td>
                                                <td class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium">
                                                    <?php if ($role['id'] != 1): // Prevent deleting admin role ?>
                                                    <form action="<?= BASE_PATH ?>/admin/roles/delete/<?= $role['id'] ?>" method="POST" onsubmit="return confirm('هل أنت متأكد من رغبتك في حذف هذا الدور؟');">
