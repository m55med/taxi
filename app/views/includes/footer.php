    ...
    <div x-data="helpButton('<?= $helpVideoId ?>')" class="fixed bottom-5 right-5 z-50">
        ...
        <a href="<?= URLROOT ?>/test.php?action=add_task&from_url=<?= urlencode($_SERVER['REQUEST_URI']) ?>" class="ml-3 bg-purple-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:bg-purple-700 transition-transform transform hover:scale-110" title="Add New Task">
