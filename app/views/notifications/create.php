...
<div class="container mx-auto p-4 sm:p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?= URLROOT ?>/notifications/history" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded transition duration-300">
            <i class="fas fa-history mr-2"></i> View History
        </a>
    </div>

    <div class="bg-white shadow-md rounded-lg p-6 sm:p-8">
        <form id="notificationForm" action="<?= URLROOT ?>/notifications/store" method="POST">
            <div class="mb-4">
            ...
            <div class="flex items-center justify-end space-x-4 space-x-reverse">
                <a href="<?= URLROOT ?>/notifications" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-300">Cancel</a>
