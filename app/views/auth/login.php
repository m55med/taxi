...
<body class="flex flex-col items-center justify-center min-h-screen px-4">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white py-8 px-6 shadow-xl rounded-xl sm:px-10">
            ...
            <form action="/taxi/login" method="POST" class="space-y-6" autocomplete="off" novalidate>
                ...
                <div class="flex items-center justify-between mb-5">
                    ...
                    <div class="text-sm">
                        <a href="<?= BASE_PATH ?>/forgot-password" class="font-medium text-indigo-600 hover:text-indigo-500"> Forgot your password? </a>
                    </div>
                </div>
        ...
        <p class="mt-8 text-center text-sm text-gray-500">
            Not a member?
            <a href="/taxi/register" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 hover:underline">
                Sign up now
            </a>
        </p>
    </div>
