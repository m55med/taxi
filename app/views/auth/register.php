...
<body class="flex flex-col items-center justify-center min-h-screen px-4 py-8">
    ...
    <div class="w-full max-w-lg">
        ...
        <div class="bg-white py-8 px-6 shadow-xl rounded-xl sm:px-10">
            ...
            <form action="/register" method="POST" class="space-y-5" autocomplete="off" novalidate>
                <div>
        ...
        <p class="mt-8 text-center text-sm text-gray-500">
            ...
            <a href="/login" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 hover:underline">
                Sign in here
            </a>
        </p>
    </div>
