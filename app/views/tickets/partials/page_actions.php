<div class="mb-6 bg-white p-4 rounded-lg shadow-md border border-gray-200">
    <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
        <!-- Search Form -->
        <form action="/tickets/search" method="POST" class="flex-grow w-full sm:w-auto relative">
            <div class="relative">
        ...
        <!-- New Ticket Button -->
        <a href="/tickets/create" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded-md w-full sm:w-auto text-center transition duration-150">
