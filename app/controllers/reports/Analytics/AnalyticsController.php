        ...
        if (!empty($_GET['period'])) {
            ...
            switch ($period) {
                ...
                case 'today':
                    ...
                    $filters['original_date_from'] = $today->format('Y-m-d');
                    $filters['original_date_to'] = $today->format('Y-m-d');

                    // تحويل للـ UTC
                    $dateFromCairo = new \DateTimeImmutable($filters['original_date_from'] . ' 00:00:00', new \DateTimeZone('Africa/Cairo'));
                    $dateToCairo = new \DateTimeImmutable($filters['original_date_to'] . ' 23:59:59', new \DateTimeZone('Africa/Cairo'));
                ...
                case '7days':
                    ...
                    $filters['original_date_from'] = $today->modify('-6 days')->format('Y-m-d');
                    $filters['original_date_to'] = (new DateTime())->format('Y-m-d');
                ...
                case '30days':
                    ...
                    $filters['original_date_from'] = $today->modify('-29 days')->format('Y-m-d');
                    $filters['original_date_to'] = (new DateTime())->format('Y-m-d');
                ...
                case 'all':
                    ...
                    $filters['original_date_from'] = null;
                    $filters['original_date_to'] = null;
