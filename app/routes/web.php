...
$router->get("delegation-types", "DelegationTypesController@index")->middleware(['admin', 'developer', 'quality_manager', 'team_leader']);
$router->post("delegation-types/create", "DelegationTypesController@create")->middleware(['admin', 'developer', 'quality_manager', 'team_leader']);
$router->post("delegation-types/update", "DelegationTypesController@update")->middleware(['admin', 'developer', 'quality_manager', 'team_leader']);
$router->post("delegation-types/delete", "DelegationTypesController@delete")->middleware(['admin', 'developer', 'quality_manager', 'team_leader']);
...
$router->post('drivers/addDocument', 'driver/DriverController@addDocument')->middleware(['admin', 'developer', 'quality_manager', 'team_leader']);
$router->post('drivers/updateDocument', 'driver/DriverController@updateDocument')->middleware(['admin', 'developer', 'quality_manager', 'team_leader']);
$router->post('drivers/removeDocument', 'driver/DriverController@removeDocument')->middleware(['admin', 'developer', 'quality_manager', 'team_leader']);
...
foreach ($reportControllers as $report) {
    ...
    $router->post("reports/{$uri}", "{$controllerPath}@index")->middleware(['admin', 'developer', 'quality_manager', 'team_leader']);
    $router->get("reports/{$uri}/getColumns", "{$controllerPath}@getColumns")->middleware(['admin', 'developer', 'quality_manager', 'team_leader']);
